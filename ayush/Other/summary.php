...
<html lang="en">
<head>
	<title>Input </title><meta charset=utf-8>
...
<body background="aaa.png">
	...
	<div id="oval_parent">
		<div id="oval">
			<div id="header"><br><br>
				<center><h1><b>Enter the text<br>Summary Generator</b></h1></center>
			</div>
			...
			<button class="login50-form-btn" name="submit">
							Enter Text
			</button>
			<input type="submit" name="submit" value="PROCEED" style="background: black; color: white; size=20px"><br><br>
            </form>
           	<form action="/ayush/textrank/sum.php" ><center>
			<input type="submit" value="SUBMIT" style="background: black; color: white; size=20px"><br><br>
			</form>
			</div>
		</div>
</body>
