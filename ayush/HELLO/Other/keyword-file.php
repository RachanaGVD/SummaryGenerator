			...
			<div class="wrap-login100">
				<form action="#" enctype="multipart/form-data" class="login100-form p-l-55 p-r-55 p-t-178" method="POST">
					<span class="login100-form-title">
						Upload the File<br>Keyword Extraction
					</span>
					<h2><b><label for="fileupload"> Select a file to upload</label> </b></h2><center>
					<p>Please rename the input file as input-file.txt</p>
				    <input type="file" name="uploaded_file"  style="background: black; color: white; size=20px"></input><br />
				    <b><a href="convert.php">Convert the file to .txt format</a></b><br><br>
				    <input type="submit" value="Upload"  style="background: black; color: white; size=20px"></input><br>
				  	</form>
				  	<form action="/ayush/textrank/key1.php" ><center>
					<input type="submit" value="View Result" style="background: black; color: white; size=20px"><br><br>
					</form>
			</div>
