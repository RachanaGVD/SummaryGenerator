		...
		<br><br>
			...
			<div class="wrap-login100">
				<form action="#" enctype="multipart/form-data" class="login100-form p-l-55 p-r-55 p-t-178" method="POST">
					...
					<h2><b><label for="fileupload"> Select a file to convert</label> </b></h2><center>
					<p>Please rename the input file as input-file.pdf</p>
				    ...
				    <input type="submit" value="Upload"  style="background: black; color: white; size=20px"></input><br>
				  	...
				  	<form action="convert1.php" ><center><br>
					<input type="submit" value="PROCEED" style="background: black; color: white; size=20px"><br><br>
					</form>
			</div>
